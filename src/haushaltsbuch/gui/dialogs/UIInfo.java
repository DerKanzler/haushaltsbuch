...
public class UIInfo extends Dialog {
	...
	protected Control createDialogArea(Composite parent) {
		...
		GridData aboutImageGD = new GridData(GridData.VERTICAL_ALIGN_CENTER | GridData.HORIZONTAL_ALIGN_CENTER | GridData.FILL_BOTH);
		...
		aboutImage.setImage(new Image(Display.getDefault(), this.getClass().getClassLoader().getResourceAsStream("images/about.png")));
