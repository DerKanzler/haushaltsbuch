...
import haushaltsbuch.widgets.LocalesCombo;
...
public class UIEinstellungen extends Dialog {
	...
	protected Control createDialogArea(Composite parent) {
		...
		Image genIcon = new Image(composite.getDisplay(), composite.getClass().getClassLoader().getResourceAsStream("images/general.png"));
		Image locIcon = new Image(composite.getDisplay(), composite.getClass().getClassLoader().getResourceAsStream("images/localization.png"));
		Image dbIcon = new Image(composite.getDisplay(), composite.getClass().getClassLoader().getResourceAsStream("images/database.png"));
		...
		generalTI.addListener(SWT.Selection, new Listener() {
			...
			public void handleEvent(Event arg0) {
				if (generalContent == null) generalContent = createGeneralContent(content);
		...
		localizationTI.addListener(SWT.Selection, new Listener() {
			...
			public void handleEvent(Event arg0) {
				if (localizationContent == null) localizationContent = createLocalizationContent(content);
		...
		databaseTI.addListener(SWT.Selection, new Listener() {
			...
			public void handleEvent(Event arg0) {
				if (databaseContent == null) databaseContent = createDatabaseContent(content);
