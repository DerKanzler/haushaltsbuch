...
import haushaltsbuch.gui.dataframes.UIBuchen;
import haushaltsbuch.gui.dataframes.UIJahrUEKapital;
import haushaltsbuch.gui.dataframes.UIJahrUEKoart;
import haushaltsbuch.gui.dataframes.UIMonatUE;
import haushaltsbuch.gui.dataframes.UISuchen;
import haushaltsbuch.gui.dataframes.UIVerwaltung;
...
public class UIDataFrame extends Composite {
	...
	public void activateBuchen() {
		...
		if (buchenFrame.hasToBeUpdated()) buchenFrame.update();
		this.layout();
	...
	public void activateSuchen() {
		...
		if (suchenFrame.hasToBeUpdated()) suchenFrame.update();
		this.layout();
	...
	public void activateMonatUE() {
		...
		if (monatUEFrame.hasToBeUpdated()) monatUEFrame.update();
		this.layout();
	}
	...
	public void activateJahrUEKapital() {
		...
		if (jahrUEKapitalFrame.hasToBeUpdated()) jahrUEKapitalFrame.update();
		this.layout();
	}
	...
	public void activateJahrUEKoart() {
		...
		if (jahrUEKoartFrame.hasToBeUpdated()) jahrUEKoartFrame.update();
		this.layout();
	}
	...
	public void activateVerwaltung() {
		...
		if (verwaltungFrame.hasToBeUpdated()) verwaltungFrame.update();
		this.layout();
	}
	...
	public void setUpdates(Boolean toBeUpdated) {
		if (buchenFrame != null) buchenFrame.setToBeUpdated(toBeUpdated);
		if (suchenFrame != null) suchenFrame.setToBeUpdated(toBeUpdated);
		if (monatUEFrame != null) monatUEFrame.setToBeUpdated(toBeUpdated);
		if (jahrUEKapitalFrame != null) jahrUEKapitalFrame.setToBeUpdated(toBeUpdated);
		if (jahrUEKoartFrame != null) jahrUEKoartFrame.setToBeUpdated(toBeUpdated);
		if (verwaltungFrame != null) verwaltungFrame.setToBeUpdated(toBeUpdated);
	}
