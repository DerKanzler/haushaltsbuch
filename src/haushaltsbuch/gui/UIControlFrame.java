...
public class UIControlFrame extends Composite implements MouseListener, MouseTrackListener {
	...
	private Image buchenIcon = new Image(this.getDisplay(), this.getClass().getClassLoader().getResourceAsStream("images/buchenIcon.png"));
	private Image suchenIcon = new Image(this.getDisplay(), this.getClass().getClassLoader().getResourceAsStream("images/suchenIcon.png"));
	private Image monatUEIcon = new Image(this.getDisplay(), this.getClass().getClassLoader().getResourceAsStream("images/monatUEIcon.png"));
	private Image jahrUEKapitalIcon = new Image(this.getDisplay(), this.getClass().getClassLoader().getResourceAsStream("images/jahrUEKapitalIcon.png"));
	private Image jahrUEKoartIcon = new Image(this.getDisplay(), this.getClass().getClassLoader().getResourceAsStream("images/jahrUEKoartIcon.png"));
	private Image verwaltungIcon = new Image(this.getDisplay(), this.getClass().getClassLoader().getResourceAsStream("images/verwaltungIcon.png"));
	
	private Image buchenIcon_glow = new Image(this.getDisplay(), this.getClass().getClassLoader().getResourceAsStream("images/buchenIcon_glow.png"));
	private Image suchenIcon_glow = new Image(this.getDisplay(), this.getClass().getClassLoader().getResourceAsStream("images/suchenIcon_glow.png"));
	private Image monatUEIcon_glow = new Image(this.getDisplay(), this.getClass().getClassLoader().getResourceAsStream("images/monatUEIcon_glow.png"));
	private Image jahrUEKapitalIcon_glow = new Image(this.getDisplay(), this.getClass().getClassLoader().getResourceAsStream("images/jahrUEKapitalIcon_glow.png"));
	private Image jahrUEKoartIcon_glow = new Image(this.getDisplay(), this.getClass().getClassLoader().getResourceAsStream("images/jahrUEKoartIcon_glow.png"));
	private Image verwaltungIcon_glow = new Image(this.getDisplay(), this.getClass().getClassLoader().getResourceAsStream("images/verwaltungIcon_glow.png"));
	...
	public void mouseUp(MouseEvent me) {
		...
		if (this.getShell().getModified()) {
			MessageBox box = new MessageBox (this.getShell(), SWT.ICON_QUESTION | SWT.PRIMARY_MODAL | SWT.YES | SWT.NO | SWT.SHEET);
