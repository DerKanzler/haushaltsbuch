...
import haushaltsbuch.logic.LogicJahrUEKoart;
...
public class UIJahrUEKoart extends UIAbstractDataFrame implements SelectionListener {
	...
	private Label incomeCurrentLabel, incomePrevYearLabel, incomeCurYearLabel, incomeDiffLabel, incomePercLabel, incomeAvgLabel;
	private Label expCurrentLabel, expPrevYearLabel, expCurYearLabel, expDiffLabel, expPercLabel, expAvgLabel;
	private Label expHHCurrentLabel, expHHPrevYearLabel, expHHCurYearLabel, expHHDiffLabel, expHHPercLabel, expHHAvgLabel;
	...
	/**
	 * Constructor: Since UIJahrUEKapital extends Composite the super constructor is called here with the given arguments.
	 * Builds the visible user interface. Uses GridLayout with 4 columns.
	 * 
	 * @param Composite
	 * @param Integer
	 */
	public UIJahrUEKoart(UIDataFrame parent, Integer style) {
		...
		previousYearButton.setImage(new Image(this.getDisplay(), this.getClass().getClassLoader().getResourceAsStream("images/back.png")));
		previousYearButton.setLayoutData(new GridData(GridData.HORIZONTAL_ALIGN_END | GridData.FILL_HORIZONTAL | GridData.VERTICAL_ALIGN_CENTER));		
		previousYearButton.addSelectionListener(this);
		
		nextYearButton = new Button(this, SWT.FLAT);
		nextYearButton.setImage(new Image(this.getDisplay(), this.getClass().getClassLoader().getResourceAsStream("images/forward.png")));
		...
		fillFields(Tools.getYear(Tools.getLastMonth()));
	}
	...
	private void buildSummaryGroup(Group group) {
		...
		incomeChartButton.setImage(new Image(this.getDisplay(), this.getClass().getClassLoader().getResourceAsStream("images/chart.png")));
		...
		incomeChartButton.addListener(SWT.Selection, new Listener() {
			public void handleEvent(Event e) {
				//new UIKapitalJahrDialog(Display.getDefault().getActiveShell(), UIKapitalJahrDialog.KAPITAL_VERFUEGBAR, logic.getDetailedData(UIKapitalJahrDialog.KAPITAL_VERFUEGBAR)).open();
			}			
		});
		
		Button incomeBookButton = new Button(incomeButtonContainer, SWT.FLAT);
		incomeBookButton.setImage(new Image(this.getDisplay(), this.getClass().getClassLoader().getResourceAsStream("images/buchungen.png")));
		...
		expChartButton.setImage(new Image(this.getDisplay(), this.getClass().getClassLoader().getResourceAsStream("images/chart.png")));
		...
		expChartButton.addListener(SWT.Selection, new Listener() {
			public void handleEvent(Event e) {
				//new UIKapitalJahrDialog(Display.getDefault().getActiveShell(), UIKapitalJahrDialog.KAPITAL_GESPERRT, logic.getDetailedData(UIKapitalJahrDialog.KAPITAL_GESPERRT)).open();
			}
		});
		
		Button expBookButton = new Button(expButtonContainer, SWT.FLAT);
		expBookButton.setImage(new Image(this.getDisplay(), this.getClass().getClassLoader().getResourceAsStream("images/buchungen.png")));
		...
		expHHChartButton.setImage(new Image(this.getDisplay(), this.getClass().getClassLoader().getResourceAsStream("images/chart.png")));
		...
		expHHChartButton.addListener(SWT.Selection, new Listener() {
			public void handleEvent(Event e) {
				//new UIKapitalJahrDialog(Display.getDefault().getActiveShell(), UIKapitalJahrDialog.KAPITAL_GESAMT, logic.getDetailedData(UIKapitalJahrDialog.KAPITAL_GESAMT)).open();
			}
		});
		
		Button expHHBookButton = new Button(expHHButtonContainer, SWT.FLAT);
		expHHBookButton.setImage(new Image(this.getDisplay(), this.getClass().getClassLoader().getResourceAsStream("images/buchungen.png")));
		...
		savChartButton.setImage(new Image(this.getDisplay(), this.getClass().getClassLoader().getResourceAsStream("images/chart.png")));
		...
		savChartButton.addListener(SWT.Selection, new Listener() {
			public void handleEvent(Event e) {
				//new UIKapitalJahrDialog(Display.getDefault().getActiveShell(), UIKapitalJahrDialog.KAPITAL_ERSPARNIS, logic.getDetailedData(UIKapitalJahrDialog.KAPITAL_ERSPARNIS)).open();
			}
		});
		
		Button savBookButton = new Button(savButtonContainer, SWT.FLAT);
		savBookButton.setImage(new Image(this.getDisplay(), this.getClass().getClassLoader().getResourceAsStream("images/buchungen.png")));
	...
	private void fillFields(Integer year) {
		...
		if (gc.get(GregorianCalendar.MONTH) == GregorianCalendar.JANUARY) {
			yearText.setMaximum(gc.get(GregorianCalendar.YEAR) - 1);
			if (year == gc.get(GregorianCalendar.YEAR)) year = year-1;
		}
		else yearText.setMaximum(gc.get(GregorianCalendar.YEAR));
		yearText.setMinimum(Tools.getYear(Tools.getFirstDate()));
		...
		if (logic.getIncDiff().compareTo(new BigDecimal(0)) < 0) incomeDiffLabel.setForeground(red);
		else if (logic.getIncDiff().compareTo(new BigDecimal(0)) > 0) incomeDiffLabel.setForeground(green);
		else incomeDiffLabel.setForeground(black);
		...
		if (logic.getExpDiff().compareTo(new BigDecimal(0)) < 0) expDiffLabel.setForeground(green);
		else if (logic.getExpDiff().compareTo(new BigDecimal(0)) > 0) expDiffLabel.setForeground(red);
		else expDiffLabel.setForeground(black);
		...
		if (logic.getExpHHDiff().compareTo(new BigDecimal(0)) < 0) expHHDiffLabel.setForeground(green);
		else if (logic.getExpHHDiff().compareTo(new BigDecimal(0)) > 0) expHHDiffLabel.setForeground(red);
		else expHHDiffLabel.setForeground(black);
		...
		if (logic.getSavDiff().compareTo(new BigDecimal(0)) < 0) savDiffLabel.setForeground(red);
		else if (logic.getSavDiff().compareTo(new BigDecimal(0)) > 0) savDiffLabel.setForeground(green);
		else savDiffLabel.setForeground(black);
