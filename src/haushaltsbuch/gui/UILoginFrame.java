...
public class UILoginFrame {
	...
	public Boolean open() {		
		...
		Image img = new Image(shell.getDisplay(), shell.getClass().getClassLoader().getResourceAsStream("images/img_login.png"));
		composite.setBackgroundImage(img);
		
		Label passwordLabel = new Label(composite, SWT.RIGHT);
		GridData passwordLabelGD = new GridData(GridData.FILL_BOTH | GridData.HORIZONTAL_ALIGN_END | GridData.VERTICAL_ALIGN_END);
