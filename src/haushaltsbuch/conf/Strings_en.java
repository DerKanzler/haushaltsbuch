...
public class Strings_en extends ResourceBundle {
	...
	public Strings_en() {
		...
		lang.put("Sum", "Total");
		lang.put("3TriesPasswd", "You have entered the wrong password three times now!\nThe application will be closed!");
		...
		lang.put("Continue", "You have unsaved changes, do you really want to continue?\nYour changes will be discarded!");
