...
public class Strings_de extends ResourceBundle {
	...
	public Strings_de() {
		...
		lang.put("Continue", "Es wurden Änderungen vorgenommen. Möchten sie wirklich fortfahren?\nIhre Änderungen werden dadurch verworfen!");
		...
		lang.put("InstallationException", "Haushaltsbuch fehlen wichtige Dateien. Das Programm muss neu installiert werden.");
	}
