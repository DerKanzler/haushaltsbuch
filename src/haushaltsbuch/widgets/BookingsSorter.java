...
public class BookingsSorter extends ViewerSorter {
	...
	private int compareKoart(Buchung booking1, Buchung booking2) {
		...
		else return booking1.getKoart().getKoartkubez().compareToIgnoreCase(booking2.getKoart().getKoartkubez());
	}
	...
	private int compareKontoVon(Buchung booking1, Buchung booking2) {
		...
		else return booking1.getKontovon().getKuerzel().compareToIgnoreCase(booking2.getKontovon().getKuerzel());
	}
	...
	private int compareKontoNach(Buchung booking1, Buchung booking2) {
		...
		else return booking1.getKontonach().getKuerzel().compareToIgnoreCase(booking2.getKontonach().getKuerzel());
	}
