...
import at.kanzler.haushaltsbuch.logic.admin.composites.LogicKoartgrpComposite;
    ...
    private void readFields() throws RuntimeException {
        if (isNew()) {
            ...
            if (logic.getKoartgrpkatSelection(koartgrpkatCombo.getSelectionIndex()) != null) {
                ...
                throw new RuntimeException("Es muss eine Kategorie gewählt werden!");
        }
        if (!koartgrpbezText.getText().equals("")) {
            koartgrp.setKoartgrpbez(koartgrpbezText.getText());
        } else
            throw new RuntimeException("Kostenartgruppenbezeichnung darf nicht leer sein!");
        if (logic.getKoartgrpartSelection(koartgrpartCombo.getSelectionIndex()) != null) {
            ...
            throw new RuntimeException("Kostenartgruppenart darf nicht leer sein!");
    }
