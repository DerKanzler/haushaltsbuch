...
import at.kanzler.haushaltsbuch.logic.admin.composites.LogicKoartComposite;
import at.kanzler.haushaltsbuch.util.GUITools;
import at.kanzler.haushaltsbuch.util.Tools;
import at.kanzler.haushaltsbuch.widgets.CostTypeGroupsCombo;
...
public class UIKoartComposite extends UIAbstractComposite implements SelectionListener {
    ...
    private Label koartkubezTitle, koartbezTitle, saldoTitle, koartgrpbezTitle, koartgrpkatTitle, koartgrpartTitle,
            messageLabel;
    ...
    private void fillFields() {
        if (!isNew) {
            ...
            koartgrpbezCombo.update(logic.getAllKoartgrp());
    }
